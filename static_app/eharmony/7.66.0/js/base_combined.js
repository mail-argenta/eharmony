...
function setCookie(e, t) {
    var n, r = null, i = null;
    (n = void 0 === setCookie.arguments ? arguments : setCookie.arguments).length > 2 && (r = n[2]),
    n.length > 3 && (i = n[3]);
    var o = e + "=" + t + "; path=/";
    if (null != r) {
        var a = r;
...
function getMainDomain(e) {
    var t = /^.*?((\.?[^.]+?)(\.([^.]+?)\.[^.]+?))$/.exec(e);
    if (t) {
        var n = t[4]
          , r = t[3];
        return "co" != n && "com" != n || (r = t[1]),
        r
    }
    return e
}
!function(e, t) {
    ...
    !function() {
        var t, r, o, a, u, l, f, p, h, g, v = H, y = T.expando, m = 0, x = 0, b = ee(), w = ee(), C = ee(), N = ee(), q = function(e, t) {
            return e === t && (u = !0),
            0
        }, O = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "(?:\\\\[\\da-fA-F]{1,6}" + A + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", P = "\\[" + A + "*(" + M + ")(?:" + A + "*([*^$|!~]?=)" + A + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + M + "))|)" + A + "*\\]", R = ":(" + M + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + P + ")*)|.*)\\)|)", I = new RegExp(A + "+","g"), W = new RegExp("^" + A + "*," + A + "*"), F = new RegExp("^" + A + "*([>+~]|" + A + ")" + A + "*"), $ = new RegExp(A + "|>"), B = new RegExp(R), _ = new RegExp("^" + M + "$"), z = {
            ID: new RegExp("^#(" + M + ")"),
            CLASS: new RegExp("^\\.(" + M + ")"),
            TAG: new RegExp("^(" + M + "|[*])"),
            ATTR: new RegExp("^" + P),
        ...
        }, X = /^(?:input|select|textarea|button)$/i, U = /^h\d$/i, V = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, G = /[+~]/, Y = new RegExp("\\\\[\\da-fA-F]{1,6}" + A + "?|\\\\([^\\r\\n\\f])","g"), Q = function(e, t) {
        ...
        function ue(e) {
            ...
            f.msMatchesSelector && L != l && (t = l.defaultView) && t.top !== t && t.addEventListener("unload", J),
                ...
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, u) {
                        ...
                        if (g) {
                            ...
                            !1 === b)
                                for (; (f = ++p && f && f[h] || (b = p = 0) || d.pop()) && (!(s ? k(f, v) : 1 === f.nodeType) || !++b || (x && ((c = f[y] || (f[y] = {}))[e] = [m, b]),
                                f !== t)); )
                                    ;
        ...
        function ce(e, t) {
            ...
            l = r.preFilter; s; ) {
                ...
                s = s.slice(n.length)),
                r.filter)
                    !(i = z[a].exec(s)) || l[a] && !(i = l[a](i)) || (n = i.shift(),
                    o.push({
                        value: n,
                        type: a,
                        matches: i
                ...
                s = C(e, function(e, t) {
                    var n = t.length > 0
                      ...
                      , a = function(a, s, u, c, f) {
                        var d, h, g, y = 0, x = "0", b = a && [], w = [], C = o, k = a || i && r.find.TAG("*", f), E = m += null == C ? 1 : Math.random() || .1, j = k.length;
                        for (f && (o = s == l || s || f); x !== j && null != (d = k[x]); x++) {
                            if (i && d) {
                                for (h = 0,
    ...
    T.fn.extend({
        ...
        is: function(e) {
            return !!I(this, "string" == typeof e && P.test(e) ? T(e) : e || [], !1).length
        }
    });
    var W, F = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
                            ...
                            var s = this
                              ...
                              , l = function() {
                                ...
                                if (!(t < o)) {
                                    ...
                                    h(l) ? i ? l.call(e, a(o, n, X, i), a(o, n, U, i)) : (o++,
                                    l.call(e, a(o, n, X, i), a(o, n, U, i), a(o, n, X, n.notifyWith))) : (r !== X && (s = void 0,
                                    u = [e]),
                                    (i || n.resolveWith)(s, u))
                                }
                            }
    ...
    Se.th = Se.td,
    d.option || (Se.optgroup = Se.option = [1, "<select multiple='multiple'>", "</select>"]);
    var Ae = /<|&#?\w+;/;
    ...
    T.event = {
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return Te.test(t.type) && t.click && k(t, "input") && Oe(t, "click", !0),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return Te.test(t.type) && t.click && k(t, "input") && Oe(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
                    return Te.test(t.type) && t.click && k(t, "input") && ie.get(t, "click") || k(t, "a")
                }
            },
            beforeunload: {
    ...
    function _e(e, t, n, r) {
        ...
        if (y || p > 1 && "string" == typeof v && !d.checkClone && Pe.test(v))
        ...
        a || r)) {
            ...
            if (u)
                ...
                f = 0; f < u; f++)
                    l = s[f],
                    ke.test(l.type || "") && !ie.access(l, "globalEval") && T.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? T._evalUrl && !l.noModule && T._evalUrl(l.src, {
                        nonce: l.nonce || l.getAttribute("nonce")
                    }, c) : m(l.textContent.replace(Re, ""), l, c))
        }
        return e
    }
    function ze(e, t, n) {
        for (var r, i = t ? T.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            ...
            r.parentNode && (n && de(r) && je(Ee(r, "script")),
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    ...
                    $e(e, s);
            return (a = Ee(s, "script")).length > 0 && je(a, !u && Ee(e, "script")),
            s
        },
    ...
    T.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (T.cleanData(Ee(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
        ...
        html: function(e) {
            return J(this, function(e) {
                ...
                if (void 0 === e && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof e && !Me.test(e) && !Se[(Ce.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = T.htmlPrefilter(e);
                    try {
                        for (; n < r; n++)
                            1 === (t = this[n] || {}).nodeType && (T.cleanData(Ee(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (e) {}
                }
        ...
        replaceWith: function() {
            ...
            return _e(this, arguments, function(t) {
                ...
                T.inArray(this, e) < 0 && (T.cleanData(Ee(this)),
    ...
    function st(e, t, n) {
        ...
        return (!d.boxSizingReliable() && i || !d.reliableTrDimensions() && k(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === T.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === T.css(e, "boxSizing", !1, r),
        (o = s in e) && (a = e[s])),
    ...
    T.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = te(t), u = Ue.test(t), l = e.style;
                if (u || (t = tt(s)),
    ...
    T.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            }) : "boolean" == typeof t && s ? t ? this.addClass(e) : this.removeClass(e) : (n = kt(e),
            this.each(function() {
                if (s)
                    for (o = T(this),
                    i = 0; i < n.length; i++)
    ...
    function Mt(e, t, n, r) {
        ...
        if (Array.isArray(t))
            T.each(t, function(t, i) {
                n || qt.test(e) ? r(e, i) : Mt(e + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, n, r)
            });
    ...
    T.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var r, i, o, a, s, u, l, c, f, p, d = T.ajaxSetup({}, n), h = d.context || d, g = d.context && (h.nodeType || h.jquery) ? T(h) : T.event, y = T.Deferred(), m = T.Callbacks("once memory"), x = d.statusCode || {}, b = {}, w = {}, C = "canceled", k = {
                readyState: 0,
            ...
            if (y.promise(k),
            d.url = ((t || d.url || Et.href) + "").replace($t, Et.protocol + "//"),
            ...
            i = d.url.replace(Rt, ""),
            d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(Pt, "+")) : (p = d.url.slice(i.length),
    ...
    T.parseHTML = function(e, t, n) {
        ...
        o = !n && [],
        (i = R.exec(e)) ? [t.createElement(i[1])] : (i = De([e], t, o),
